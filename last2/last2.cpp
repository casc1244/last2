...
#pragma once
//参数设置	
#define OPENPOSE_VIDEO		"D:\\斗鱼视频\\美人鱼_1.mp4"
using namespace cv;
using namespace std;
using namespace dnn;
//非极大值抑制去掉置信度较低的bouding box
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:\\0opencv\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\0opencv\\openpose_caffe_models\\caffe_models\\pose\\coco\\pose_iter_440000.caffemodel";
